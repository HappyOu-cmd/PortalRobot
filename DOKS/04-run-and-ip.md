...
- Node.js 20 или новее и npm для HMI и gateway;
- CODESYS 3.5 с установленными библиотеками проекта для PLC;
- современный Chromium-браузер для проверки HMI.

Версии npm-зависимостей зафиксированы в `visu/package-lock.json`. После получения проекта сначала выполнять `npm install`, не копировать чужую папку `node_modules`.
