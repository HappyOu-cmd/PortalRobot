...
export const FAULT_SIMULATION_SYMBOLS = new Set([
  ...
  'xSimulationAccelerationPending',
  'xSimulationAccelerationBusy',
  ...
  'xSimSafetyEmergencyStopMpg',
  'xSimSafetyPhaseRelayFault',
  'xSimSafetyPressureRelayFault',
  'xSimSafetyRelayFault',
  ...
  ...[1, 2, 3, 4].flatMap((index) => [
    `axSimSafetyEmergencyStopStation[${index}]`,
    `axSimSafetyDoorUnlocked[${index}]`,
  ]),
  ...
  ...statusSymbols('stSafetyFaultStatus'),
